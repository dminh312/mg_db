  ...
  <div class="container mt-5" style="max-width:720px;">
    <div class="auth-card">
      ...
      <form v-if="!loading" @submit.prevent="handleSubmit" novalidate>
        ...
        <div class="form-row">
          <button type="submit" class="btn-primary" :disabled="isLoading">Update Product</button>
    ...
    async handleSubmit() {
      ...
      try {
        ...
        if (res.data?.success) {
          ...
          this.error = res.data?.message || 'Failed to update product.'
        }
      } catch (err) {
        ...
        else this.error = 'Failed to update product. Please try again.'
      } finally {
